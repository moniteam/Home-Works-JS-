...
function getNmbers()
{
	...
	// findNumbers(diapasoneBottom, diapasoneTop);
	// summEvenNumbers(diapasoneBottom, diapasoneTop);
}

// Глобальные переменные (я не знал, куда их пихануть)
let selectFunction;
